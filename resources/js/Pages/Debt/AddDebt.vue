...
const handleRupiahInput = (event) => {
    ...
    form.debtAmount_show = rupiah(inputVal);
    form.debtAmount = inputVal.replace(/[^0-9]/g, "");
};
...
const submitForm = async () => {
    ...
    try {
        const response = await axios.post("/api/new-debt", payload);
        ...
        >
            <div class="mb-3">
                <label
                    ...
                    >Nama Hutang <span style="color: red">*</span></label
                >
                <div class="mt-2">
                    <input
                        type="text"
                        v-model="form.debtName"
                        id="debtName"
            ...
            <div class="mb-3">
                <label
                    for="debtDate"
                    class="block text-sm/6 font-medium text-gray-900 dark:text-white"
                    >Debt Date <span style="color: red">*</span></label
                >
                <div class="mt-2 flex">
                    <div
