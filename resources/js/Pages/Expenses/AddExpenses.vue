...
const today = () => {
    ...
    form.expensesDate = formattedDate;
};
...
const handleRupiahInput = (event) => {
    ...
    form.expensesAmount_show = rupiah(inputVal);
    form.expensesAmount = inputVal.replace(/[^0-9]/g, "");
};
...
const submitForm = async () => {
    ...
    const payload = {
        expensesName: form.expensesName,
        expensesDate: form.expensesDate,
        expensesAmount: form.expensesAmount,
    };

    try {
        const response = await axios.post("/api/new-expenses", payload);
        ...
        >
            <div class="mb-3">
                <label
                    ...
                    >Nama Pengeluaran <span style="color: red">*</span></label
                >
                <div class="mt-2">
                    <input
                        type="text"
                        v-model="form.expensesName"
                        id="expensesName"
                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500"
                        placeholder="Beli Game Steam"
                    />
                </div>
            </div>
            <div class="mb-3">
                <label
                    for="expensesDate"
                    class="block text-sm/6 font-medium text-gray-900 dark:text-white"
                    >Expenses Date <span style="color: red">*</span></label
                >
                <div class="mt-2 flex">
                    <div
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                    ...
                    >
                        ...
                        <input
                            type="text"
                            v-model="form.expensesAmount_show"
                            @input="handleRupiahInput"
                            id="expensesAmount_show"
